    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('memorydevice', '存储设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'online'), (1, 'outline'), (2, 'unknown'), (3, 'fault'), (4, 'backup')], default=0, verbose_name='设备状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '操作系统'), (1, '办公开发软件'), (2, '业务软件')], default=0, verbose_name='软件类型')),
                ('license_num', models.IntegerField(default=1, verbose_name='授权数量')),
                ('version', models.CharField(help_text='example: RedHat release 7 (Final)', max_length=64, unique=True, verbose_name='软件/系统版本')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, 'PC服务器'), (1, '刀片服务器'), (2, '小型服务器')], default=0, verbose_name='服务器类型')),
                ('created_by', models.CharField(choices=[('auto', '自动录入'), ('manual', '人工录入')], default='auto', max_length=32, verbose_name='录入方式')),
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
                ('host_on', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='host_on_server', to='precious.server', verbose_name='宿主机')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '防火墙'), (1, '入侵检测设备'), (2, '互联网网关'), (3, '漏洞扫描设备'), (4, '运维审计系统')], default=0, verbose_name='安全设备类型')),
                ('model', models.CharField(default='unknown', max_length=128, verbose_name='安全设备型号')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
            ],
            options={
                'verbose_name': '安全设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ram_size', models.CharField(blank=True, max_length=64, null=True, verbose_name='内存大小')),
                ...
                ('manufacturer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.manufacturer', verbose_name='生产厂商')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(default='unknown', max_length=128, verbose_name='网络设备型号')),
                ...
                ('device_detail', models.TextField(blank=True, null=True, verbose_name='详细设备')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(default='unknown', max_length=128, verbose_name='存储设备型号')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
            ],
            options={
                'verbose_name': '存储设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('asset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.asset')),
                ('new_asset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.newassetapprovalzone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=64, null=True, verbose_name='备注')),
                ('parent_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_level', to='precious.businessunit')),
            ],
            options={
                'verbose_name': '业务线',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.businessunit', verbose_name='所属业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.contract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.idc', verbose_name='所在机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='precious.manufacturer', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
            field=models.ManyToManyField(blank=True, to='precious.Tag', verbose_name='标签'),
        ),
        migrations.CreateModel(
            name='RAM',
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
            ],
            options={
                'verbose_name': '内存',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_mask', models.CharField(blank=True, max_length=64, null=True, verbose_name='子网掩码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, max_length=128, null=True, verbose_name='硬盘型号')),
                ('manufacturer', models.CharField(blank=True, max_length=128, null=True, verbose_name='硬盘制造商')),
                ('capacity', models.FloatField(blank=True, null=True, verbose_name='磁盘容量(GB)')),
                ('disk_interface_type', models.CharField(choices=[(0, 'SATA'), (1, 'SAS'), (2, 'SCSI'), (3, 'SSD'), (4, 'unknown')], default=4, max_length=16, verbose_name='接口类型')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='precious.asset')),
            ],
            options={
                'verbose_name': '硬盘',
